...
A running log of issues hit while building / running this project. Replace or extend the example rows with the real problems you encounter — keep dates and the *root cause* honest, because the grader reads this to see that you actually built the thing.
...
> **How to use this log**
> - One row per real problem. Don't pad with cosmetic noise.
> - The *Root cause* column is the most useful one for the grader — be specific, name the file/cell.
> - If you replace an example row, keep the same column order so the table renders.
